...
files.forEach(file => {
    ...
    // Backgrounds
    content = content.replace(/bg-industrial-dark/g, 'bg-white'); // Bright background for fun look
    ...
    // Headings to Outfit font
    content = content.replace(/font-sans/g, 'font-sans'); // already sans
    // We can add font-heading to h1, h2, h3 manually later or globally
