...
export class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-white text-dicrejart-violet p-6">
          <div className="bg-red-500/20 border border-red-500 rounded-lg p-6 max-w-2xl w-full">
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-500 text-dicrejart-violet px-4 py-2 rounded font-medium transition-colors"
            >
              Recargar página
            </button>
          </div>
